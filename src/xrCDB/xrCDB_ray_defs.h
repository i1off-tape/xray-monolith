//---------------------------------------------------------------------------
// Shared ray/aabb intersection primitives used by the CDB ray colliders
// (xrCDB_ray.cpp and ISpatial_q_ray.cpp). Extracted here so the FPU/SSE
// slab-test implementation is maintained in a single place.
//---------------------------------------------------------------------------
#ifndef xrCDB_ray_defsH
#define xrCDB_ray_defsH
